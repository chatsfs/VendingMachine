...
//  VendingMachine
//
//  Created by Raul Bigoria Escobedo on 21/12/17.
...
class FoodVendingMachine: VendingMachine {
    let selection: [VendingSelection] = [.soda, .dietSoda, .chips,.candyBar,.sandwich,.wrap,.popTart,.water,.fruitJuice,.gum,.sportsDrink]
    var inventory: [VendingSelection : VendingItem]
